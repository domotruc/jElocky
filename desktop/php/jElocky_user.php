<div class="col-lg-10 col-md-9 col-sm-8 eqLogic jElocky_user"
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active"><a href="#user_eqtab" aria-controls="home" role="tab" data-toggle="tab"><i
                class="fa fa-tachometer"></i> {{Equipement}}</a></li>
        <li role="presentation"><a href="#user_cmdtab" aria-controls="profile" role="tab" data-toggle="tab"><i
